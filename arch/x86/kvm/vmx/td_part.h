			...
			struct tdx_module_args *out)
{
	...
	if (!out)
		...
		memset(out, 0, sizeof(struct tdx_module_args));
		out->rcx = rcx;
		out->rdx = rdx;
		out->r8 = r8;
		out->r9 = r9;
...
static inline u64 tdg_vm_read(u64 field_id, struct tdx_module_args *out)
{
...
static inline u64 tdg_vp_read(u64 field_id, struct tdx_module_args *out)
{
...
static inline u64 tdg_mem_page_accept(u64 ept_map_info, struct tdx_module_args *out)
{
...
static inline u64 tdg_vp_invept(u64 vm_idx_bitmap, struct tdx_module_args *out)
{
